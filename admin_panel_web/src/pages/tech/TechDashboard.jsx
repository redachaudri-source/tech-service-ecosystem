        ...
        try {
            ...
            const filtered = safeData.filter(t => {
                ...
                try {
                    ...
                    console.warn('Invalid date for ticket:', t.id);
                    return false;
                }
            });
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex justify-between items-end px-1">
                <div>
                    <h2 className="text-2xl font-bold text-slate-800 capitalize">{dateString.split(',')[0]}</h2>
                    <p className="text-slate-500 text-sm capitalize">{dateString}</p>
                </div>
                {/* Date Picker (Hidden or simple prev/next could go here) */}
            </div>
