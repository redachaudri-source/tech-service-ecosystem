...
import { X, Calendar, ClipboardList, CheckCircle, AlertCircle, Settings, LogOut, User, Star, Clock, Package, ShieldAlert } from 'lucide-react'; // Added Star, ShieldAlert
...
const TechSidebar = ({ isOpen, onClose, user, onSignOut }) => {
    ...
    { label: 'Reclamaciones', icon: ShieldAlert, path: '/tech/warranties' },
