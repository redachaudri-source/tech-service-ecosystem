-- ANALYTICS V2 (BYPASS MODE)
-- Creates a BRAND NEW function name to avoid conflicts with old versions.
...
GRANT EXECUTE ON FUNCTION get_analytics_v2 TO authenticated;
GRANT EXECUTE ON FUNCTION get_analytics_v2 TO service_role;
